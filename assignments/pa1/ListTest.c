...
// cd /workspaces/CSE101/assignments/pa1
// gcc ListTest.c List.c -o ListTest 
// ./ListTest
    //to see output

#include "/workspaces/CSE101/assignments/pa1/List.h"
...
//    printList(stdout, B);
//    fprintf(stdout, "\n");
//    fprintf(stdout, "A %s B\n\n", equals(A, B)?"equals":"does not equal");
...
//    printList(stdout, C);
//    fprintf(stdout, "\n");
//    fprintf(stdout, "A %s C\n\n", equals(A, C)?"equals":"does not equal");
...
//    printList(stdout, A);
//    fprintf(stdout, "\n");
//    fprintf(stdout, "length(E) = %d, length(A) = %d\n\n", length(E), length(A));
...
// // (1, 2, 3, 4, 5, 100, 6, 7, 1, 2, 3, 4, 5, 6, 7)
// // length(D) = 14

// // (1, 2, 3)
// // (4, 5, 100, 6, 7)
// // length(E) = 3, length(A) = 5
